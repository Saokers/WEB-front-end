var serverBase = 'http://172.31.18.157:8080/Shopping'
...
export default {
  ...
  API_uploadImg: v1 + "/user/fileUploadfile",
  /**获取标签 */
  API_getLabel: v1 + 'note/getSysDataDict',

  API_getDict: v1 + 'note/getNoteData',
  API_sendComment: v1 + 'note/setInteraction',
  API_URL_CART_COMMIT: v1 + 'user/orders/commitOrder',
  API_URL_CART_ORDER: v1 + 'order',
  /**提交图片 */
  API_SET_NOTEDATA: v1 + 'note/setNoteData',

  API_SET_SELECTCOUNT: v1 + 'note/selectCount',
  /**充值记录 */
  API_URL_CUSTOMER_Record: v1 + 'account/record',
  /**添加足迹 */
  API_URL_FOOTPRINT_ADD: v1 + 'footprint/add',
  /**查询足迹 */
  API_URL_FOOTPRINT_SELECT: v1 + 'footprint/select'
