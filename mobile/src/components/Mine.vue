    ...
    data () {
      return {
        row: [{
          ...
          title: '常用联系人',
          icon: require('../../static/img/2.png'),
          url: '/samsara/concat'
        }, {
          title: '我的收藏',
          icon: require('../../static/img/collect.png'),
          url: '/samsara/collect'
        }, 
        {
          title: '我的足迹',
          icon: '../../static/img/footprint.png',
          url: '/samsara/myfootprint'
        },
         {
          title: '会员设置',
          icon: require('../../static/img/4.png'),
          url: '/samsara/setting'
        },{
          title: '未支付订单',
          icon: require('../../static/img/payment.png'),
          url: '/samsara/payment'
        },{
          title: '电子钱包充值',
